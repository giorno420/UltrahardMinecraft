...
import com.giornosmp.ultrahardminecraft.HostileMobs.SkeletonTypeMobs;
...
public final class UltrahardMinecraft extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ReduceFoodSources(), this); // halves all livestock and fish
        ...
        getServer().getPluginManager().registerEvents(new SkeletonTypeMobs(), this); // gives you a withering effect when attacked by skeletons and strays
        getServer().getPluginManager().registerEvents(new ToolsRequireExperience(), this); // all iron and diamond tools require experience levels to be used
